...
const SSS = [
  ...
  { soru: "İptal edebilir miyim?", cevap: "Tek seferlik ödeme olduğu için abonelik veya otomatik yenileme yoktur. Ödeme iadesi için 7 gün içinde iletişime geçebilirsiniz." },
