...
const PARTNER_LINKS = [
  ...
  { href: "/partner#paketler",  label: "Davet Evleri İçin" },
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 py-14 flex flex-col md:flex-row items-center justify-between gap-6">
          <div>
            <p className="text-3xl md:text-4xl text-white/90 mb-1"
              ...
              Online davetiyeni bugün oluştur
            </p>
      ...
      <div className="border-t border-white/5">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 py-5">
          <div className="flex flex-col lg:flex-row items-center justify-between gap-5">
            ...
            <div className="flex flex-col sm:flex-row items-center gap-3 sm:gap-4">
              <a
                href={`https://wa.me/${YASAL_BILGILER.whatsappDestek}?text=${encodeURIComponent("Merhaba, davetiye hakkında yardım almak istiyorum.")}`}
                target="_blank"
                rel="noopener noreferrer"
                className="flex items-center gap-2 bg-[#25D366]/10 border border-[#25D366]/25 text-[#25D366] text-xs font-medium px-3.5 py-1.5 rounded-full hover:bg-[#25D366]/20 hover:border-[#25D366]/40 transition-all"
              >
