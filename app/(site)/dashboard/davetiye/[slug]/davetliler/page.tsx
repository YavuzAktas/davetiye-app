                                  ...
                                  <div className="flex flex-col sm:flex-row sm:items-center gap-2">
                                    ...
                                    <div className="grid grid-cols-2 gap-2 sm:flex sm:shrink-0">
                                      <button
                                        ...
                                        className="flex items-center justify-center gap-1.5 h-8 px-3 rounded-xl bg-indigo-50 text-indigo-600 hover:bg-indigo-100 transition-all text-xs font-semibold"
                                      >
                                      ...
                                      <a
                                        ...
                                        className="flex items-center justify-center gap-1.5 h-8 px-3 rounded-xl bg-violet-50 text-violet-600 hover:bg-violet-100 transition-all text-xs font-semibold"
                                        title="QR kodu indir"
                                      >
                ...
                <>
                  ...
                  <div className="divide-y divide-gray-50">
                    {cevaplamayanlar.map(davetli => {
                      const g = GRUP_MAP[davetli.grup] ?? GRUP_MAP.diger;
                      return (
                        <div key={davetli.id} className="flex flex-col sm:flex-row sm:items-center gap-3 px-5 py-4">
                          ...
                          <div className="grid grid-cols-2 sm:flex sm:items-center gap-1.5 sm:shrink-0 w-full sm:w-auto">
                            {davetli.telefon && (
                              <a
                                ...
                                className="col-span-2 sm:col-span-1 flex items-center justify-center gap-1.5 bg-[#25D366] text-white text-xs px-3.5 py-2 rounded-xl hover:opacity-90 transition-opacity font-semibold"
                              >
