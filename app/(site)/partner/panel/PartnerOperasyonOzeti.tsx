...
export default function PartnerOperasyonOzeti({
  ...
  return (
    <section className="overflow-hidden rounded-3xl border border-gray-100 bg-white shadow-sm">
      ...
      <div className="flex justify-end border-t border-gray-100 bg-gray-50 px-5 py-4 lg:px-7">
        <a
          href="#aktivasyon-kodlari"
          className="inline-flex items-center justify-center rounded-xl bg-purple-600 px-4 py-2.5 text-xs font-black text-white transition-colors hover:bg-purple-700"
        >
          Aktivasyonlara Git
        </a>
      </div>
