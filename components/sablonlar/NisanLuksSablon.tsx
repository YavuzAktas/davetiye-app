      ...
      <div style={{ marginTop:22, border:`1px solid ${GOLD}24`, borderRadius:10, overflow:"hidden", background:"rgba(196,160,90,0.06)" }}>
        <button type="button" onClick={() => setEkBilgiAcik(!ekBilgiAcik)} style={{
          ...
          <span>
            ...
            <span style={{ display:"block", fontSize:11, color:"#8B6550", marginTop:2 }}>Diyet tercihi veya şarkı dileği</span>
          </span>
        ...
        {ekBilgiAcik && (
          <div style={{ padding:"0 14px 14px", borderTop:`1px solid ${GOLD}18` }}>
            {form.katilim === "evet" && (
              <div style={{ marginTop:14 }}>
                ...
                {secilenDiyet.length > 0 && (
                  <label style={{ display:"flex", gap:8, alignItems:"flex-start", marginTop:12, fontFamily:"var(--font-cormorant),serif", fontSize:11, lineHeight:1.5, color:"#8B6550", cursor:"pointer" }}>
            ...
            <div style={{ marginTop:14 }}>
              <label style={labelStyle}>🎵 Şarkı dileğiniz <span style={{ textTransform:"none", letterSpacing:0, fontSize:10, color:"#8B6550" }}>(isteğe bağlı)</span></label>
